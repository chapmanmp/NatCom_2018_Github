...
for a = 1 : N_AGENT 
    ...
    for k = 1 : N_T
        ...
        for i = 1 : n
            ...
            tspl{a}{i}{1}(k) = mean( xs_ki ); tsplF{a}{i}{1}(k) = mean( xs_ki./ts_k );
            
            tspl{a}{i}{2}(k) = std(  xs_ki ); tsplF{a}{i}{2}(k) = std(  xs_ki./ts_k );
            
            xHATs_ki = MHAT{a}( i, cols_k );
            
            pred{a}{i}{1}(k) = mean( xHATs_ki ); predF{a}{i}{1}(k) = mean( xHATs_ki./tHATs_k );
            
            pred{a}{i}{2}(k) = std(  xHATs_ki ); predF{a}{i}{2}(k) = std(  xHATs_ki./tHATs_k );
